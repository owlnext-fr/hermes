...
- Créer un endpoint de test ping pour valider la bonne marche du serveur
- Créer le guard de sécurité pour authentifier un APIUser
- Créer un endpoint de test pour valider le guard de sécurité
